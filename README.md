...
<img width="400" src="assets/img/Sentiment_per_category.png">{:style="display: block; margin: 0 auto" }
...
<img width="400" src="assets/img/Heat_per_category.png">{:style="display: block; margin: 0 auto" }
